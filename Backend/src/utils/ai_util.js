    ...
    try {
        const chatCompletion = await openai.chat.completions.create({
            messages: [
                ...
                {
                    role: 'assistant',
                    content: `According to the bio provided, please write a description of an ideal match, in 2-3 sentences.
        ...
        const idealPartnerProfile = (_b = (_a = chatCompletion.choices[0]) === null || _a === void 0 ? void 0 : _a.message) === null || _b === void 0 ? void 0 : _b.content; //This is a profile which is generated if there aren't matches found
